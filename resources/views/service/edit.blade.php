                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action=" {{ route('service.update', $serve->id) }}"
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="title" value="{{ $serve->title }}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="image" style="padding: .500rem"
                                id="exampleInputUsername1" placeholder="Add Service Image">
                        </div> --}}
                            ...
                            <tbody>
                                ...
                                @foreach ($service as $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('service.delete', $item->id) }}"  onclick=" return confirm('Are You Sure!') "><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
