                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="linkdIn" value="{{$employ->linkdIn}}" class="form-control" style="padding: .500rem"
                                    placeholder="LinkdIn">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <tbody>
                                ...
                                @foreach ($employee as $item)
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('employee.edit', $item->id) }}"><i class="fa-solid fa-pen"></i> </a></td>
                                        <td><a href="{{ route('employee.delete', $item->id) }} "  onclick=" return confirm('Are You Sure!') "><i class="fa-solid fa-trash"></i></label></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
