          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="../../images/head.jpg" alt="logo"> <span style="font-size: 1.2em; font-weight:bold">ST PETER'S COLLEGE</span>              </div>
               @include('errors')
              <form class="pt-3"  method="POST" action="{{route('login')}}" >
               {{csrf_field()}}
                ...
                <a href="{{route('password')}}" class="text-primary">Forgotten Password?</a>
                </div>
                <hr>
                <div class="text-center mt-4 font-weight-light">
