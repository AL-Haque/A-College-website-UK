                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('map.store') }}"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-1" style="padding-top:.4rem">
                                    <p>Map Url</p>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($maps as $item)
                                        <tr>
                                            ...
                                            <td> <a href="{{ route('map.edit', $item->id) }}"><i class="fa-solid fa-pen"></i> </a></td>
                                            <td><a href="{{ route('map.delete', $item->id) }}"  onclick=" return confirm('Are You Sure!') "><i class="fa-solid fa-trash"></i></label></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
