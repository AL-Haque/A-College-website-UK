            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('product.update',$productt->id)}} "  enctype="multipart/form-data" >
                            {{ csrf_field() }}
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" value="{{$productt->name}}" class="form-control" style="padding: .500rem"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="category_id"
                                        ...
                                        <option selected>{{$productt->category_id}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="sub_id" id="exampleInputUsername1">
                                        <option selected>{{$productt->sub_id}}</option>
                            ...
                            <div class="col-sm-3" style="max-width: 20%; padding-top:20px">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-sm" name="description"  style="padding: .500rem" name="description" id="editor" cols="20"
                                            rows="4">{{$productt->description}}</textarea>
                                    </div>
                                </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img id="img-preview" src="{{ asset('images/'.$productt->image) }}" width="220px"
                            height="150px" />
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <td><a href="{{route('service.delete', $item->id) }}"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
